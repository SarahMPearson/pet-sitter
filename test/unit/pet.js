...
describe('Pet', function(){
  ...
  describe('#eat', function(){
    it('should increase health and full and decrease energy', function(){
      var pet = new Pet('Fluffy', 3, 'female', 'lizard');
      pet.health  = 90;
      pet.energy  = 30;
      pet.full    = 20;
  ...
  describe('#attack', function(){
    ...
    describe('#resurrect', function(){
      ...
      it('should not resurrect the pet because the are do not have 5 points', function() {
        var fluffy = new Pet('fluffy', 3, 'female', 'sloth');
        fluffy.isZombie = true;
        fluffy.wins = 3;
      ...
      it('should not resurrect the pet because they are alive', function() {
        var fluffy = new Pet('fluffy', 3, 'female', 'sloth');
